...
// <auto-generated>
//
// Generated from file `Murmur122.ice'
//
...
/**
* This file has been generated for phpMumbleAdmin with slice2php 3.5.1
* Remove this line below if you want to use this script with another application.
*/
...
if(!class_exists('Murmur_UserInfo'))
{
    ...
    $Murmur__t_UserInfo = IcePHP_defineEnum('::Murmur::UserInfo', array('UserName', 0, 'UserEmail', 1, 'UserComment', 2, 'UserHash', 3, 'UserPassword', 4));
}
...
if(!interface_exists('Murmur_Server'))
{
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'isRunning', 2, 2, 0, null, null, array($IcePHP__t_bool, false, 0), null);
    IcePHP_defineOperation($Murmur__t_Server, 'start', 0, 0, 0, null, null, null, array($Murmur__t_ServerBootedException, $Murmur__t_ServerFailureException));
    IcePHP_defineOperation($Murmur__t_Server, 'stop', 0, 0, 0, null, null, null, array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'delete', 0, 0, 0, null, null, null, array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'id', 2, 2, 0, null, null, array($IcePHP__t_int, false, 0), null);
    IcePHP_defineOperation($Murmur__t_Server, 'addCallback', 0, 0, 0, array(array($Murmur__t_ServerCallbackPrx, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidCallbackException));
    IcePHP_defineOperation($Murmur__t_Server, 'removeCallback', 0, 0, 0, array(array($Murmur__t_ServerCallbackPrx, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidCallbackException));
    IcePHP_defineOperation($Murmur__t_Server, 'setAuthenticator', 0, 0, 0, array(array($Murmur__t_ServerAuthenticatorPrx, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidCallbackException));
    IcePHP_defineOperation($Murmur__t_Server, 'getConf', 2, 2, 0, array(array($IcePHP__t_string, false, 0)), null, array($IcePHP__t_string, false, 0), null);
    IcePHP_defineOperation($Murmur__t_Server, 'getAllConf', 2, 2, 0, null, null, array($Murmur__t_ConfigMap, false, 0), null);
    IcePHP_defineOperation($Murmur__t_Server, 'setConf', 2, 2, 0, array(array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0)), null, null, null);
    IcePHP_defineOperation($Murmur__t_Server, 'setSuperuserPassword', 2, 2, 0, array(array($IcePHP__t_string, false, 0)), null, null, null);
    IcePHP_defineOperation($Murmur__t_Server, 'getLog', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, array($Murmur__t_LogList, false, 0), null);
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'getChannels', 2, 2, 0, null, null, array($Murmur__t_ChannelMap, false, 0), array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'getCertificateList', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), null, array($Murmur__t_CertificateList, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException));
    IcePHP_defineOperation($Murmur__t_Server, 'getTree', 2, 2, 0, null, null, array($Murmur__t_Tree, false, 0), array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'getBans', 2, 2, 0, null, null, array($Murmur__t_BanList, false, 0), array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'setBans', 2, 2, 0, array(array($Murmur__t_BanList, false, 0)), null, null, array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'kickUser', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException));
    IcePHP_defineOperation($Murmur__t_Server, 'getState', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), null, array($Murmur__t_User, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException));
    IcePHP_defineOperation($Murmur__t_Server, 'setState', 2, 2, 0, array(array($Murmur__t_User, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException, $Murmur__t_InvalidChannelException));
    IcePHP_defineOperation($Murmur__t_Server, 'sendMessage', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException));
    IcePHP_defineOperation($Murmur__t_Server, 'hasPermission', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, array($IcePHP__t_bool, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException, $Murmur__t_InvalidChannelException));
    IcePHP_defineOperation($Murmur__t_Server, 'addContextCallback', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0), array($Murmur__t_ServerContextCallbackPrx, false, 0), array($IcePHP__t_int, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidCallbackException));
    IcePHP_defineOperation($Murmur__t_Server, 'removeContextCallback', 0, 0, 0, array(array($Murmur__t_ServerContextCallbackPrx, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidCallbackException));
    IcePHP_defineOperation($Murmur__t_Server, 'getChannelState', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), null, array($Murmur__t_Channel, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException));
    IcePHP_defineOperation($Murmur__t_Server, 'setChannelState', 2, 2, 0, array(array($Murmur__t_Channel, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException));
    IcePHP_defineOperation($Murmur__t_Server, 'removeChannel', 0, 0, 0, array(array($IcePHP__t_int, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException));
    IcePHP_defineOperation($Murmur__t_Server, 'addChannel', 0, 0, 0, array(array($IcePHP__t_string, false, 0), array($IcePHP__t_int, false, 0)), null, array($IcePHP__t_int, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException));
    IcePHP_defineOperation($Murmur__t_Server, 'sendMessageChannel', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_bool, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException));
    IcePHP_defineOperation($Murmur__t_Server, 'getACL', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), array(array($Murmur__t_ACLList, false, 0), array($Murmur__t_GroupList, false, 0), array($IcePHP__t_bool, false, 0)), null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException));
    IcePHP_defineOperation($Murmur__t_Server, 'setACL', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($Murmur__t_ACLList, false, 0), array($Murmur__t_GroupList, false, 0), array($IcePHP__t_bool, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException));
    IcePHP_defineOperation($Murmur__t_Server, 'addUserToGroup', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSessionException));
    IcePHP_defineOperation($Murmur__t_Server, 'removeUserFromGroup', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSessionException));
    IcePHP_defineOperation($Murmur__t_Server, 'redirectWhisperGroup', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException));
    IcePHP_defineOperation($Murmur__t_Server, 'getUserNames', 2, 2, 0, array(array($Murmur__t_IdList, false, 0)), null, array($Murmur__t_NameMap, false, 0), array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'getUserIds', 2, 2, 0, array(array($Murmur__t_NameList, false, 0)), null, array($Murmur__t_IdMap, false, 0), array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'registerUser', 0, 0, 0, array(array($Murmur__t_UserInfoMap, false, 0)), null, array($IcePHP__t_int, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidUserException));
    IcePHP_defineOperation($Murmur__t_Server, 'unregisterUser', 0, 0, 0, array(array($IcePHP__t_int, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidUserException));
    IcePHP_defineOperation($Murmur__t_Server, 'updateRegistration', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($Murmur__t_UserInfoMap, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidUserException));
    IcePHP_defineOperation($Murmur__t_Server, 'getRegistration', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), null, array($Murmur__t_UserInfoMap, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidUserException));
    IcePHP_defineOperation($Murmur__t_Server, 'getRegisteredUsers', 2, 2, 0, array(array($IcePHP__t_string, false, 0)), null, array($Murmur__t_NameMap, false, 0), array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'verifyPassword', 2, 2, 0, array(array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0)), null, array($IcePHP__t_int, false, 0), array($Murmur__t_ServerBootedException));
    IcePHP_defineOperation($Murmur__t_Server, 'getTexture', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), null, array($Murmur__t_Texture, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidUserException));
    IcePHP_defineOperation($Murmur__t_Server, 'setTexture', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($Murmur__t_Texture, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidUserException, $Murmur__t_InvalidTextureException));
...
if(!interface_exists('Murmur_Meta'))
{
    ...
    IcePHP_defineOperation($Murmur__t_Meta, 'getServer', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), null, array($Murmur__t_ServerPrx, false, 0), null);
    IcePHP_defineOperation($Murmur__t_Meta, 'newServer', 0, 0, 0, null, null, array($Murmur__t_ServerPrx, false, 0), null);
    IcePHP_defineOperation($Murmur__t_Meta, 'getBootedServers', 2, 2, 0, null, null, array($Murmur__t_ServerList, false, 0), null);
    IcePHP_defineOperation($Murmur__t_Meta, 'getAllServers', 2, 2, 0, null, null, array($Murmur__t_ServerList, false, 0), null);
    IcePHP_defineOperation($Murmur__t_Meta, 'getDefaultConf', 2, 2, 0, null, null, array($Murmur__t_ConfigMap, false, 0), null);
    ...
    IcePHP_defineOperation($Murmur__t_Meta, 'addCallback', 0, 0, 0, array(array($Murmur__t_MetaCallbackPrx, false, 0)), null, null, array($Murmur__t_InvalidCallbackException));
    IcePHP_defineOperation($Murmur__t_Meta, 'removeCallback', 0, 0, 0, array(array($Murmur__t_MetaCallbackPrx, false, 0)), null, null, array($Murmur__t_InvalidCallbackException));
