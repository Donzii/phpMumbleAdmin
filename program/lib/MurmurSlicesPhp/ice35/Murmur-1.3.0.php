...
if(!class_exists('Murmur_WriteOnlyException'))
{
    class Murmur_WriteOnlyException extends Murmur_MurmurException
    {
        public function __construct()
        {
            parent::__construct();
    ...
    $Murmur__t_WriteOnlyException = IcePHP_defineException('::Murmur::WriteOnlyException', 'Murmur_WriteOnlyException', false, $Murmur__t_MurmurException, null);
}

if(!class_exists('Murmur_InvalidInputDataException'))
{
    class Murmur_InvalidInputDataException extends Murmur_MurmurException
    {
        public function __construct()
        {
            parent::__construct();
    ...
    $Murmur__t_InvalidInputDataException = IcePHP_defineException('::Murmur::InvalidInputDataException', 'Murmur_InvalidInputDataException', false, $Murmur__t_MurmurException, null);
}
...
if(!interface_exists('Murmur_Server'))
{
    interface Murmur_Server
    {
        ...
        public function updateCertificate($certificate, $privateKey, $passphrase);
    }
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'getConf', 2, 2, 0, array(array($IcePHP__t_string, false, 0)), null, array($IcePHP__t_string, false, 0), array($Murmur__t_InvalidSecretException, $Murmur__t_WriteOnlyException));
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'updateCertificate', 2, 2, 0, array(array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException, $Murmur__t_InvalidInputDataException));
}
