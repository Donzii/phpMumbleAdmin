...
$TEXT['add_srv'] = 'Virtuellen Server hinzufügen';
...
$TEXT['del_srv'] = 'Virtuellen Server löschen';
$TEXT['confirm_reset_srv'] = 'Komplettes Zurücksetzen des virtuellen Servers #%d?'; // %d = server ID
$TEXT['reset_srv_info'] = 'Komplettes Rücksetzen der Konfiguration des virtuellen Servers: Entfernt alle Kanäle, registrierte Benutzer, Bans, ACLs, Gruppen und änderte das Superuser-Passwort';
$TEXT['generate_su_pw'] = 'Neues Passwort für den SuperUser generieren?';
