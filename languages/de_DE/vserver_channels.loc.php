...
$TEXT['img_defaultchannel'] = 'Standard Channel';
$TEXT['img_temp'] = 'Temporärer Channel';
$TEXT['img_link_direct'] = 'Direkter Link';
$TEXT['img_link_undirect'] = 'Undirekter Link';
$TEXT['img_priorityspeaker'] = 'Priorität Lautsprecher Benutzer';
$TEXT['img_recording'] = 'Benutzer nimmt auf';
$TEXT['img_linked'] = 'Kanal mit einem Link aber nicht mit dem ausgewählten Kanal verbunden';

$TEXT['add_channel'] = 'Sub-Channel hinzufügen';
$TEXT['confirm_del_channel'] = 'Löschen den Channels und seine Sub-Channels?';
$TEXT['move_user_in_chan'] = 'Benutzer in einen Channel verschieben';
$TEXT['send_msg_to_all_sub'] = 'Nachricht an alle Sub-Channel';
$TEXT['select_in_right_tree'] = 'Wähle einen Channel im rechten Channelbaum.';
$TEXT['move_user_off_chan'] = 'Verschobene Benutzer';
$TEXT['move_channel'] = 'Verschiebe den Channel';
...
$TEXT['action'] = 'Aktion';
$TEXT['send_msg'] = 'Nachricht senden';
$TEXT['move'] = 'Verschiebe';
$TEXT['mute'] = 'Mute';
$TEXT['unmute'] = 'Unmute';
$TEXT['deafen'] = 'Taub';
...
$TEXT['channel_desc'] = 'Channel Beschreibung';
$TEXT['channel_pw'] = 'Channel PassworT';
$TEXT['channel_pos'] = 'Channel Position';
$TEXT['udp_ping'] = 'UDP ping ( Sprache )';
$TEXT['tcp_ping'] = 'TCP ping ( Kontrolle )';
