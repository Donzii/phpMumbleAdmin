...
$TEXT['ice_help_unauth'] = 'PhpMumbleAdmin hat einen Fehler mit ICE festgestellt.<br>Alle Aktivitäten wurde während des Fehlers deaktiviert.<br>Bitte wenden Sie sich an den Admin.';
$TEXT['ice_help_upgrade_murmur'] = 'PMA untersteutze nicht diese Version von murmur.<br>Aktualisieren Sie auf 1.2.0 oder höher.';
$TEXT['ice_help_slice_file'] = 'Murmur.ice oder slice-php Datei ist nicht kompatibel mit Ihrem murmur-Dämon. Das Profil wurde deaktiviert.';
...
$TEXT['InvalidChannelException'] = 'Dieser Channel existiert nicht oder wurde gelöscht.';
$TEXT['InvalidUserException'] = 'Diese Registrierung gibt es nicht oder wurde gelöscht.';
...
$TEXT['vserver_dont_exists'] = 'Der Server existiert nicht oder wurde gelöscht.';
...
$TEXT['new_su_pw'] = 'Neüs Passwort für den SuperUser: %s'; // %s new SuperUser password
...
$TEXT['vserver_created_success'] = 'Virtüller Server wurde erstellt.';
$TEXT['vserver_deleted_success'] = 'Virtüller Server wurde gelöscht.';
