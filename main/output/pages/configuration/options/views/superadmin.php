...
$actionBox->set_conf( 'onSubmit', 'return validate_SuperAdmin( this );' );
$actionBox->set_conf( 'submit_txt', $TEXT['modify'] );

$actionBox->cancel( 'toolbox' );
$actionBox->form();
$actionBox->input( 'hidden', 'cmd', 'config_admins' );
$actionBox->input( 'hidden', 'edit_SuperAdmin', '' );
$actionBox->table();
$actionBox->tr_title( 'SuperAdmin' );
$actionBox->tr( 'password', $TEXT['enter_your_pw'], 'current', '' );
$actionBox->tr_pad();
$actionBox->tr( 'text', $TEXT['sa_login'], 'login', $PMA->config->get( 'SA_login' ) );
$actionBox->tr_pad();
