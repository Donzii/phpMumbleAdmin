...
$registration = $PMA->admins->get( $_GET['remove_admin'] );
...
$actionBox->input( 'hidden', 'remove_admin', $registration['id'] );
$actionBox->confirm( $registration['login'], $TEXT['confirm_del_admin'] );
